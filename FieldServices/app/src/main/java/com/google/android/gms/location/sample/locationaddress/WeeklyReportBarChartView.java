...
public class WeeklyReportBarChartView extends DemoView {
     ...
     * @param context
     */
    public WeeklyReportBarChartView(Context context,
    ...
    private static AFreeChart createChart(CategoryDataset dataset) {
        ...
        AFreeChart chart = ChartFactory.createBarChart(
                "Field Serivces Weekly Attendance", // chart
                // title
                "Date", // domain axis label
                "Attendance Count", // range axis label
                dataset, // data
