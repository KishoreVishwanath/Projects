...
public class TechTrnxsBarChartView extends DemoView {
	 ...
	 * @param context
	 */
	public TechTrnxsBarChartView(Context context,
			Map<String, Integer> s,Map<String, Integer> f) {
		super(context);

		CategoryDataset dataset = createDataset(s,f);
	...
	private static CategoryDataset createDataset(
			Map<String, Integer> st,Map<String, Integer> ft) {
