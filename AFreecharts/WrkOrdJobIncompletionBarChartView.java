...
public class WrkOrdJobIncompletionBarChartView extends DemoView {
	 ...
	 * @param context
	 */
	public WrkOrdJobIncompletionBarChartView(Context context,
	...
	private static AFreeChart createChart(CategoryDataset dataset) {
		...
		AFreeChart chart = ChartFactory.createBarChart(
				"CLICK Managed Job Incompletion rate", // chart
				// title
				"Job Incompletion rate", // domain axis label
