...
public class TechLogInOutsLineChartView extends DemoView {
	 ...
	 * @param context
	 */
	public TechLogInOutsLineChartView(Context context, Map<String, Integer> s,
	 ...
	 * @return The dataset.
	 */
	private static CategoryDataset createDataset(Map<String, Integer> st,
